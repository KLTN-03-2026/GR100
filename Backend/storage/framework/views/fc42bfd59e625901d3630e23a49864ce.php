                    ...
                    <tr>
                        <td style="padding:32px 36px;">
                            <p style="font-size:16px;color:#374151;line-height:26px;margin:0 0 8px;">
                                Xin chào <strong style="color:#6366F1;"><?php echo e($data['ho_ten']); ?></strong>,
                            </p>
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td style="padding-left:12px;">
                                            ...
                                            <p style="margin:4px 0 0;font-size:14px;color:#6366F1;"><?php echo e($data['email']); ?></p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
                         ...
                         box-shadow:0 6px 20px rgba(99,102,241,0.35);letter-spacing:0.3px;">
                            ...
                            <div style="background:#F5F3FF;border-radius:8px;padding:16px;margin:0 0 24px;">
                                ...
                                <p style="font-size:13px;word-break:break-all;margin:0;">
                                    <a href="<?php echo e($data['link']); ?>" style="color:#6366F1;text-decoration:none;"><?php echo e($data['link']); ?></a>
                                </p>
                            </div>
...
</html><?php /**PATH C:\xampp\htdocs\moiNhat\Volunteer-Management\Backend\resources\views/quen_mat_khau.blade.php ENDPATH**/ ?>